...
import { ArrowUp, MessageCircle, AlertCircle } from "lucide-react";

export default function GameInterface() {
  const [imageUrl, setImageUrl] = useState("https://toppng.com/uploads/preview/cute-pusheen-cat-drawings-11549780281jhaxjprj03.png");
