...
const MOCK_DATABASE = [
  { id: 1, name: "Classic White Tee", type: "Clothing", price: 10, image: "https://placehold.co/200?text=Shirt" },
  { id: 2, name: "Wireless Mouse", type: "Electronics", price: 25, image: "https://placehold.co/200?text=Mouse" },
  { id: 3, name: "Ceramic Mug", type: "Home", price: 20, image: "https://placehold.co/200?text=Mug" },
  { id: 4, name: "Denim Jeans", type: "Clothing", price: 50, image: "https://placehold.co/200?text=Jeans" },
  { id: 5, name: "Mechanical Keyboard", type: "Electronics", price: 100, image: "https://placehold.co/200?text=Keyboard" },
  { id: 6, name: "Succulent Plant", type: "Home", price: 30, image: "https://placehold.co/200?text=Plant" },
];
  ...
  return (
    <div className="shop-container">
      <header className="shop-header">
        <button onClick={() => router.push("/pet")} className="back-btn" title="Go back">
