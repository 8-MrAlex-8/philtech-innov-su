    ...
    <div className="h-dvh flex items-center justify-center bg-neutral-100">
      <div className="w-[85dvw] md:w-[30dvw] p-8 rounded-2xl bg-white shadow-lg text-center">
        ...
        <h2 className="text-2xl font-semibold mb-6">
          Your Class: Female Warrior
        </h2>
        <p className="text-sm text-neutral-600 mb-8">
          You've chosen the Female Warrior! Complete quests, level up skills,
          and master your day like a true adventurer.
        </p>
...
export default FemaleWarriorPage;
